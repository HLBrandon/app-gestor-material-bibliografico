...
public class ListarEditorialesActivity extends AppCompatActivity {

    private Button btnAgregar, btnVolver;

    private RecyclerView editorialRecyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editorialRecyclerView = findViewById(R.id.recyclerViewEditoriales);
        editorialRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        editorialAdapter = new EditorialAdapter();
        editorialRecyclerView.setAdapter(editorialAdapter);
        ...
        btnAgregar.setOnClickListener(v -> {
            Intent crear = new Intent(ListarEditorialesActivity.this, RegistrarEditorialesActivity.class);
            startActivity(crear);
        });
        ...
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (jsonArray != null) {
                            ...
                            editorialAdapter.setEditoriales(editoriales);
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ListarEditorialesActivity.this, "Error: " + error.toString(), Toast.LENGTH_LONG).show();
                    }
                });
