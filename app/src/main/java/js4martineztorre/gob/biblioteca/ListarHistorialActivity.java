...
import js4martineztorre.gob.biblioteca.model.HistorialAdapter;
...
public class ListarHistorialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prestamoRecyclerView.setAdapter(historialAdapter);
        ...
        btnSc.setOnClickListener(v -> {
            IntentIntegrator integrator = new IntentIntegrator(ListarHistorialActivity.this);
    ...
    private void listar_prestamos () {
        String url = Utilidades.HISTORIAL;
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                        ...
                        if (jsonArray != null) {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                try {
                                    ...
                                    String fecha_prestamo = jsonObject.optString("fecha_prestamo", "No hay fecha");
                                    String fecha_devolucion = jsonObject.optString("fecha_devolucion", "No hay fecha");

                                    int estatus = jsonObject.optInt("estatus", 0);
                                    int perder = jsonObject.optInt("perder", 0);

                                    Prestamo prestamo = new Prestamo(id, nombre, apellido, correo, titulo, isbn, estatus, perder, fecha_prestamo, fecha_devolucion);
                            ...
                            historialAdapter.setHistorial(prestamos);
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ListarHistorialActivity.this, "Error: " + error.toString(), Toast.LENGTH_LONG).show();
                    }
                });
